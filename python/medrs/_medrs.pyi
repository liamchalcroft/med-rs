...
Interpolation = Literal["nearest", "trilinear", "linear"]
DType = str | np.dtype[Any] | type | Any
Shape3 = tuple[int, int, int] | Sequence[int]
...
class NiftiImage:
    ...
    def __init__(self, data: npt.ArrayLike, affine: npt.ArrayLike | None = None) -> None: ...
    @property
    ...
    def to_numpy(self, dtype: DType | None = None, *, copy: bool = False) -> npt.NDArray[Any]: ...
    def __array__(
        self, dtype: DType | None = None, copy: bool | None = None
    ) -> npt.NDArray[Any]: ...
    def to_torch(self, dtype: DType | None = None, device: Any = None) -> Any: ...
    def to_jax(self, dtype: DType | None = None, device: Any = None) -> Any: ...
    def save(
        self,
        path: StrPath,
        *,
        ...
        chunk_shape: Shape3 | None = None,
    ) -> None: ...
    def resample(
        self, spacing: Sequence[float], interpolation: Interpolation = "trilinear"
    ) -> NiftiImage: ...
    def resample_to_shape(
        self, shape: Shape3, interpolation: Interpolation = "trilinear"
    ) -> NiftiImage: ...
    def resample_like(
        self, reference: NiftiImage, interpolation: Interpolation = "trilinear"
    ) -> NiftiImage: ...
    def reorient(self, orientation: str) -> NiftiImage: ...
    def crop(self, offset: Shape3, shape: Shape3) -> NiftiImage: ...
    def crop_or_pad(self, shape: Shape3, pad_value: float = 0.0) -> NiftiImage: ...
...
class Pipeline:
    ...
    def crop(self, offset: Shape3, shape: Shape3) -> Pipeline: ...
    def crop_or_pad(self, shape: Shape3, pad_value: float = 0.0) -> Pipeline: ...
    ...
    def cast(self, dtype: DType) -> Pipeline: ...
...
class FastLoader:
    ...
    def __init__(
        self,
        images: Sequence[StrPath],
        patch_shape: Shape3,
        *,
        labels: Sequence[StrPath] | None = None,
...
def load(path: StrPath, *, cache: bool = False) -> NiftiImage: ...
def load_cropped(path: StrPath, offset: Shape3, shape: Shape3) -> NiftiImage: ...
def load_header(path: StrPath) -> Header: ...
def load_multi(
    paths: Sequence[StrPath],
    *,
    reference: int = 0,
    interpolation: Interpolation | Sequence[Interpolation] | None = None,
) -> list[NiftiImage]: ...
